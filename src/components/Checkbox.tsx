...
const Checkbox = ({ checked, toggle }: CheckboxProps) => {
  return (
    <button
      ...
      } h-[1.1rem] w-[1.1rem] border p-0.5 cursor-pointer flex items-center justify-center border-primary-medium hover:border-primary-blue transition-colors rounded-md`}
    >
